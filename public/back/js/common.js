...
//前端是不知道用户是否登录的,但是后台知道,想知道,问后台,(访问后台接口即可)
//注意:需要将登陆页,排除在外面,就是登陆页可以不登陆就访问
if (location.href.indexOf("login.html")===-1) {
    //从头到尾地检索字符串href,如果含有login.html,则对应索引为第二个参数,如果索引值小于0,说明在地址栏参数中没有login.html需要登陆拦截
    $.ajax({
        type:"GET",
